...
BOT_TOKEN = environ.get('BOT_TOKEN', "8048349120:AAEt_PVSV1ZmQSunMvqW7QrXCHeVdmMzIa8")
...
PICS = (environ.get('PICS', 'https://envs.sh/V_q.jpgl https://envs.sh/y9D.jpgp https://envs.sh/V_B.jpgl https://envs.sh/V_T.jpgl')).split()  # Sample pic
NOR_IMG = environ.get("NOR_IMG", "https://envs.sh/V_p.jpg")
MELCOW_VID = environ.get("MELCOW_VID", "https://envs.sh/V_A.jpg")
SPELL_IMG = environ.get("SPELL_IMG", "https://envs.sh/V_T.jpgl")
SUBSCRIPTION = (environ.get('SUBSCRIPTION', 'https://envs.sh/V_T.jpgl'))
FSUB_PICS = (environ.get('FSUB_PICS', 'https://envs.sh/V_T.jpgl https://envs.sh/V_A.jpg')).split()  # Fsub pic
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002359583084').split()]  # Channel id for auto indexing (make sure bot is admin)
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', ' -1002475155819'))  # Log channel id (make sure bot is admin)
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '-1002475155819'))  # Bin channel id (make sure bot is admin)
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002436220651')  # Channel/Group ID for force sub (make sure bot is admin)
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '-1002474691060').split()]
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002460755631')  # Support group id (make sure bot is admin)
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002436220651')  # Request channel id (make sure bot is admin)
AUTH_CHANNEL = [int(fch) if id_pattern.search(fch) else fch for fch in environ.get('AUTH_CHANNEL', '-1002436220651').split()]
MULTI_FSUB = [int(channel_id) for channel_id in environ.get('MULTI_FSUB', '-1002436220651').split() if re.match(r'^-?\d+$', channel_id)]  # Channel for force sub (make sure bot is admin)


# ============================
# Payment Configuration
# ============================
QR_CODE = environ.get('QR_CODE', 'https://envs.sh/V__.jpg')
OWNER_UPI_ID = environ.get('OWNER_UPI_ID', 'Getepay.scbqrapp135018@icici')
...
DATABASE_URI2 = environ.get('DATABASE_URI2', "mongodb+srv://arpitadas200006:auD6mw5Xp0JIPZwc@cluster0.siy52.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/tutorialshortlinks/8')  # Tutorial video link for opening shortlink website
...
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/vfzteueei')
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/+ZGttiqb6CelhOGI1')  # Support group link (make sure bot is admin)
