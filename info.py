...
BOT_TOKEN = environ.get('BOT_TOKEN', "7755351901:AAFNB3Go7ytLStP-1lJyGcPWrF2xHNZX6F8")
...
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '-1002406799151'))  # Bin channel id (make sure bot is admin)
